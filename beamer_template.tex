...
\ifxetex
  ...
  \setCJKmainfont[ItalicFont={华文仿宋}]{Hiragino Sans GB}               % 中文字体
  % \setCJKmainfont[ItalicFont={华文仿宋},BoldFont={Lantinghei SC}]{Lantinghei SC Extralight}               % 中文字体
  % \setCJKmainfont{华文仿宋}               % 中文字体
  % \setCJKmainfont{Source Han Sans CN}               % 中文字体
  \setmainfont{Helvetica Neue}                % 英文字体
  ...
  % \setbeamercolor{quote}{fg=blue!80}
...
\setkeys{Gin}{height=\ScaleHeightIfNeeded,keepaspectratio}%
$endif$
